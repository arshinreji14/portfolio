  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-black">
      ...
      <div className="hidden md:block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center ">
        <h1 className="text-gray-600 md:text-8xl text-6xl font-bold opacity-40">FRONTEND</h1>
        <h1 className="text-gray-600 md:text-8xl text-6xl font-bold pl-32 opacity-40">WEB</h1>
        <h1 className="text-gray-600 md:text-8xl text-6xl font-bold opacity-40">DEVELOPER</h1>
      ...
      <div className="relative z-10 grid md:grid-cols-3 gap-10 items-center p-7 md:pl-14 w-full">
        ...
        <div className="col-span-1 text-center md:text-left animate-fade-up  " >
        ...
        <div className='col-span-1'>
        <div className="relative w-full  h-[500px] md:h-[600px] animate-fade-left ">
            <Image
